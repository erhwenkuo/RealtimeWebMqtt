module.exports = function (redis_client, mqtt_client) {
    ...
    ctrl.get_unread = function (req, res) {
        ...
        var list_key = "demo/whoisonline/" + user_id + "/notification";
        ...
        var result = redis_client.lrange(list_key, 0, unread, function (err, resp) {
            if (err) {
                ...
                redis_client.set("demo/whoisonline/" + user_id + "/notification/unread", "0");
                
                // publish mqtt message to notify the counter change
                mqtt_client.publish("demo/whoisonline/" + user_id + "/notification/unread" , "0" , { qos: 0, retain: true });
